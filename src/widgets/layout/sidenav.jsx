...
export function Sidenav({ brandName, routes }) {
  ...
  return (
    <Card className={`${sidenavTypes[sidenavType]} ${openSidenav ? "translate-x-0" : "-translate-x-80"} shadow-none fixed inset-0  py-4 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 transition-transform duration-300 xl:translate-x-0`}>
      ...
      <Card.Body className="p-3 mt-4">
         <List>
           ...
           {title ? title : <span className="text-sm uppercase -mx-2">Auth Pages</span>}
            </List.Item>
            </Link>
          ))}
         </List> 
